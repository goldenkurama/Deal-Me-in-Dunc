...
export const TRINKETS: readonly TrinketDefinition[] = Object.freeze([
  ...
  { id: "dry-cleaning-ticket", name: "Mini Vacuum", description: "Once per hand, name a suit and remove all played cards of that suit from both hands.", interaction: "click" },
  ...
  { id: "dry-cleaning-tag", name: "Dry Cleaning Ticket", description: "Before betting, name a suit. Win with that suit in your hand for double profit.", interaction: "pre-bet" },
